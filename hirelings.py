...
def check_character_class():
    roll = roll1d10()
     if roll == 1:
        then character_class="Magician"
    elif roll == 2:
        then character_class="Priest"
    elif roll == 3:
        then character_class="Priest"
    elif 4 < roll <= 6:
        then character_class="Burglar"
    else:
        then character_class="Warrior"  
...
def check_common_ancestry():
    roll = roll1d10()
     if roll == 1:
        ...
        then ancestry="Ancestry: Dominent for Region"   
